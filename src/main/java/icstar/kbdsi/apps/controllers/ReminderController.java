...
//                categoryRepository.findAllByName(name, PageRequest.of(0, 10, Sort.by("name").ascending()));
    ...
    private Page<Reminder> getRemindersWithDescription(PaginationReminderDto paginationReminderDto) {
        Page<Reminder> reminders = reminderService.findReminderContainingDescription(paginationReminderDto.getDescription(), paginationReminderDto.getPageNum(), paginationReminderDto.getPageSize());
        return reminders;
    }
